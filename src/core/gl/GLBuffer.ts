...
export class AttributeInfo {
  ...
  /**
   * Size (number of elements) in this attribute
   */
  public size: number
...
export class GLBuffer {
   ...
   * @param dataType - data type this buffer. Default gl.FLOAT
   * @param targetBufferType - buffer target type. Can be either gl.ARRAY_BUFFER or gl.ELEMENT_ARRAY_BUFFER. Default: gl.ARRAY_BUFFE
   * @param mode - drawing mode of this buffer (i.e. gl.TRIANGLES or gl.LINES). Default: gl.TRIANGLES
   */
  public constructor(
    elementSize: number,
    ...
    switch (this._dataType) {
      ...
      default:
        throw Error(`Unrecognized data type: ${dataType.toString()}`)
    }
